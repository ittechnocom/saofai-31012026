        ...
        <div class="dashboard">
            ...
            <div class="sensor-card">
                ...
                <div class="card-value">
                    <span><?php echo number_format($latest_data['temperature'], 1); ?></span>
            ...
            <div class="sensor-card">
                ...
                <div class="card-value">
                    <span><?php echo number_format($latest_data['humidity'], 1); ?></span>
            ...
            <div class="sensor-card">
                ...
                <div class="card-value">
                    <span><?php echo number_format($latest_data['light'], 0); ?></span>
            ...
            <div class="sensor-card">
                ...
                <div class="card-value">
                    <span><?php echo number_format($latest_data['windspeed'], 1); ?></span>
            ...
            <div class="sensor-card">
                ...
                <div class="card-value">
                    <span><?php echo number_format($latest_data['dust'], 3); ?></span>
        ...
        <div class="table-section">
            ...
            <table>
                ...
                <tbody>
                    ...
                    $sql_history = "SELECT * FROM sensor_data ORDER BY timestamp DESC LIMIT $limit";
                    ...
                    if ($result_history && $result_history->num_rows > 0) {
                        ...
                        while ($row = $result_history->fetch_assoc()) {
                            ...
                            echo "<td>" . number_format($row['temperature'], 1) . " °C</td>";
                            echo "<td>" . number_format($row['humidity'], 1) . " %</td>";
                            echo "<td>" . number_format($row['light'], 0) . " lux</td>";
                            echo "<td>" . number_format($row['windspeed'], 1) . " m/s</td>";
                            echo "<td>" . number_format($row['dust'], 3) . " mg/m³</td>";
